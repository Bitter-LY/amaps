...
export const primaryColor = '#646cff'
export const primaryColorHover = '#4f80fb'
export const primaryColorPressed = '#4f60fb'
export const primaryColorSuppl = primaryColor
